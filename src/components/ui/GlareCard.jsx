...
/**
 * GlareCard – A high-end card component with dynamic glare, skew, and holographic effects.
...
export const GlareCard = ({
  ...
  return (
    <div
      ...
      className={cn(
        "relative isolate [contain:layout_style] [perspective:600px] transition-transform duration-[var(--duration)] ease-[var(--easing)] delay-[var(--delay)] will-change-transform w-full aspect-[17/21]",
        className
      )}
      ref={refElement}
      onPointerMove={(event) => {
    ...
    >
      <div className="h-full grid will-change-transform origin-center transition-transform duration-[var(--duration)] ease-[var(--easing)] delay-[var(--delay)] [transform:rotateY(var(--r-x))_rotateX(var(--r-y))] rounded-[var(--radius)] border border-white/10 hover:[--opacity:0.3] hover:[--duration:200ms] hover:[--easing:linear] hover:filter-none overflow-hidden bg-zinc-900/50 backdrop-blur-xl">
